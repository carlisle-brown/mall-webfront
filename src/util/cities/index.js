var _cities={
    ...
    getProvinces : function(){
        var provices = [];
        for(var i=0,length=this.cityInfo.length; i<length; i++){
             provices.push(this.cityInfo[i].provice);
        }
        return provices;
    },
    // 获取省份所有城市
    getcities : function(proviceName){
        ...
        // return this.cityInfo[proviceName] || []
        for(var i=0,length=this.cityInfo.length; i<length; i++){
            if(this.cityInfo[i].provice === proviceName){
                return this.cityInfo[i].city
            }
        }
    }
}
